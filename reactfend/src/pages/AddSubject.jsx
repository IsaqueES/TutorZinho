        ...
        <div className="w-full max-w-xl">
            ...
            >
              ...
              <div className="space-y-3">
                ...
                <p className="text-sm text-gray-400 flex items-center">
                  ...
                  Digite um nome claro e descritivo para a matéria
                </p>
              </div>
          ...
          <div className="mt-8 bg-gray-800/20 backdrop-blur-lg border border-gray-700/30 rounded-2xl p-6">
            <div className="flex items-center mb-3">
              <div className="w-6 h-6 bg-gradient-to-br from-emerald-500 to-emerald-700 rounded-lg flex items-center justify-center text-sm mr-3">
                💡
              </div>
              <h3 className="text-lg font-semibold text-white">Dica</h3>
            </div>
            <p className="text-gray-300 text-sm leading-relaxed">
              Escolha nomes objetivos e fáceis de identificar. Isso ajudará
              professores e alunos a encontrarem as matérias rapidamente.
            </p>
          </div>
